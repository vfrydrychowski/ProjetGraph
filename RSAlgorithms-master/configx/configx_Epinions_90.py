...
class ConfigX(object):
    ...
    def __init__(self):
        ...
        self.rating_path = "../data/epinions/ratings_data.txt" % self.dataset_name  # the raw ratings data file
        self.rating_cv_path = "../data/cv/epinions"  # the cross validation file of ratings data
        self.trust_path = '../data/epinions/ratings_trust.txt' % self.dataset_name  # the raw trust data file
