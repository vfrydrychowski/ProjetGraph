...
class SocialReg(MF):
    ...
    def init_model(self, k):
        ...
        for user in self.rg.user:
            top_k_followees = process_graph.find_top_k_followees(user,self.tg.get_followees(user),list_commu,df)
    ...
    def train_model(self, k, verbose = True):
        ...
        while iteration < self.config.maxIter:
            ...
            for index, line in enumerate(self.rg.trainSet()):
                ...
                top_k_followers = process_graph.find_top_k_followees(user,followers,list_commu,df)
