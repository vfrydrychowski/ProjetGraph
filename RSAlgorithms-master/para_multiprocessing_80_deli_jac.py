...
from configx.configx_Delicious_80 import ConfigX as  Deli80
from model.social_reg_jaccard import goSocialReg
...
def worker(rank, return_dict):
    ...
    deli80 =  Deli80()
    rmses, maes = goSocialReg(deli80, rank, verbose = False)
